...
const { Progress, getSpawn, calcTemporaryFilename } = require('./helper.js');
...
async function unionAndClipFeatures(filenameIn, filenameClip, filenameOut) {
	...
	stream = stream.pipe(zlib.createGzip()).pipe(fs.createWriteStream(filenameTmp));
