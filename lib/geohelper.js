...
async function convertGzippedGeoJSONSeq2Anything(fullnameIn, fullnameOut, layerType) {
...
async function unionAndClipFeaturesDC(filenameIn, filenameClip, filenameOut) {
	...
	await convertGzippedGeoJSONSeq2Anything(tempFilenameOut, filenameOut, 'Polygon');
