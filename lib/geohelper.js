...
module.exports = {
	...
	convertGzippedGeoJSONSeq4GeoBasis,
	coords2Feature,
	demercator,
	doBboxOverlap,
	features2Coords,
		...
		pipeline
			...
			.finished(async () => {
				...
				for (let file of filesOut.values()) {
					...
					convertGzippedGeoJSONSeq4GeoBasis(file.filenameGeoJSONSeq, file.filenameOut);
				}
...
function convertGzippedGeoJSONSeq4GeoBasis(filenameIn, filenameOut) {
	//convertGzippedGeoJSONSeq2Anything(filenameIn, filenameOut + '.fgb');
	convertGzippedGeoJSONSeq2Anything(filenameIn, filenameOut + '.gpkg');
}
