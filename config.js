...
const config = {
	...
	rules: [
		...
		{ ags: 7, name:'Rheinland-Pfalz',
			wohngebiet:(h,r) => (h+r)<200 ? 1000 : 1100,
			wohngebaeude:500,
			/*gesundheit:800,*/ autobahn:40,
			bundesstr:20,
			landesstr:20,
			kreisstr:15,
			freileitung:(h,r) => 3*r
		...
		{ ags:14, name:'Sachsen',
			//https://www.revosax.sachsen.de/vorschrift_gesamt/1779/44172.html
			wohngebaeude: 1000,
			wohngebiet:      0,
		},
		{ ags:15, name:'Sachsen-Anhalt',
			wohngebiet:1000,
			/*gesundheit:1200,*/ camping:(h,r) => Math.max(1000, 10*(h+r)),
			gewerbe:500,
			erholung:1000,
			/*denkmal:1000,*/ naturdenkmal:1000,
			naturschutz:200,
			nationalpark:1000,
